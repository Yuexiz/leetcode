# :pencil2: Leetcode Solutions with Swift,C
Update time:  2019-07-01 13:02:13

Auto created by [leetcode_generate](https://github.com/bonfy/leetcode)

I have solved **20   /   1043** problems
while there are **161** problems still locked.

If you want to use this tool please follow this [Usage Guide](https://github.com/bonfy/leetcode/blob/master/README_leetcode_generate.md)

If you have any question, please give me an [issue](https://github.com/Yuexiz/leetcode/issues).
...
|:---:|:---:|:---:|:---:|:---:|
|1|[two-sum](https://leetcode.com/problems/two-sum)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/001-two-sum/two-sum.swift)|[:memo:](https://leetcode.com/articles/two-sum/)|Easy|
|2|[add-two-numbers](https://leetcode.com/problems/add-two-numbers)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/002-add-two-numbers/add-two-numbers.swift)|[:memo:](https://leetcode.com/articles/add-two-numbers/)|Medium|
...
|4|[median-of-two-sorted-arrays](https://leetcode.com/problems/median-of-two-sorted-arrays)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/004-median-of-two-sorted-arrays/median-of-two-sorted-arrays.swift)|[:memo:](https://leetcode.com/articles/median-of-two-sorted-arrays/)|Hard|
...
|7|[reverse-integer](https://leetcode.com/problems/reverse-integer)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/007-reverse-integer/reverse-integer.swift) [C](https://github.com/Yuexiz/leetcode/blob/master/007-reverse-integer/reverse-integer.c)|[:memo:](https://leetcode.com/articles/reverse-integer/)|Easy|
|8|[string-to-integer-atoi](https://leetcode.com/problems/string-to-integer-atoi)|||Medium|
|9|[palindrome-number](https://leetcode.com/problems/palindrome-number)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/009-palindrome-number/palindrome-number.swift) [C](https://github.com/Yuexiz/leetcode/blob/master/009-palindrome-number/palindrome-number.c)|[:memo:](https://leetcode.com/articles/palindrome-number/)|Easy|
...
|14|[longest-common-prefix](https://leetcode.com/problems/longest-common-prefix)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/014-longest-common-prefix/longest-common-prefix.swift)|[:memo:](https://leetcode.com/articles/longest-common-prefix/)|Easy|
...
|20|[valid-parentheses](https://leetcode.com/problems/valid-parentheses)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/020-valid-parentheses/valid-parentheses.swift)|[:memo:](https://leetcode.com/articles/valid-parentheses/)|Easy|
|21|[merge-two-sorted-lists](https://leetcode.com/problems/merge-two-sorted-lists)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/021-merge-two-sorted-lists/merge-two-sorted-lists.swift)|[:memo:](https://leetcode.com/articles/merged-two-sorted-lists/)|Easy|
...
|26|[remove-duplicates-from-sorted-array](https://leetcode.com/problems/remove-duplicates-from-sorted-array)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/026-remove-duplicates-from-sorted-array/remove-duplicates-from-sorted-array.swift)|[:memo:](https://leetcode.com/articles/remove-duplicates-from-sorted-array/)|Easy|
|27|[remove-element](https://leetcode.com/problems/remove-element)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/027-remove-element/remove-element.swift)|[:memo:](https://leetcode.com/articles/remove-element/)|Easy|
|28|[implement-strstr](https://leetcode.com/problems/implement-strstr)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/028-implement-strstr/implement-strstr.swift)||Easy|
...
|35|[search-insert-position](https://leetcode.com/problems/search-insert-position)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/035-search-insert-position/search-insert-position.swift)||Easy|
...
|53|[maximum-subarray](https://leetcode.com/problems/maximum-subarray)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/053-maximum-subarray/maximum-subarray.swift)|[:memo:](https://leetcode.com/articles/maximum-subarray/)|Easy|
...
|58|[length-of-last-word](https://leetcode.com/problems/length-of-last-word)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/058-length-of-last-word/length-of-last-word.swift)||Easy|
...
|67|[add-binary](https://leetcode.com/problems/add-binary)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/067-add-binary/add-binary.swift)||Easy|
|68|[text-justification](https://leetcode.com/problems/text-justification)|||Hard|
|69|[sqrtx](https://leetcode.com/problems/sqrtx)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/069-sqrtx/sqrtx.swift)||Easy|
|70|[climbing-stairs](https://leetcode.com/problems/climbing-stairs)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/070-climbing-stairs/climbing-stairs.swift)|[:memo:](https://leetcode.com/articles/climbing-stairs/)|Easy|
...
|83|[remove-duplicates-from-sorted-list](https://leetcode.com/problems/remove-duplicates-from-sorted-list)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/083-remove-duplicates-from-sorted-list/remove-duplicates-from-sorted-list.swift)|[:memo:](https://leetcode.com/articles/remove-duplicates-from-sorted-list/)|Easy|
...
|88|[merge-sorted-array](https://leetcode.com/problems/merge-sorted-array)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/088-merge-sorted-array/merge-sorted-array.swift)|[:memo:](https://leetcode.com/articles/merge-sorted-arrays/)|Easy|
...
|100|[same-tree](https://leetcode.com/problems/same-tree)|[Swift](https://github.com/Yuexiz/leetcode/blob/master/100-same-tree/same-tree.swift)|[:memo:](https://leetcode.com/articles/same-tree/)|Easy|
